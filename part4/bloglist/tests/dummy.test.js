...
describe("total likes", () => {
  ...
  test("when list has 5 blogs, equals the likes of total likes", () => {
...
describe("favourite blog", () => {
  ...
  test("when list has 5 blogs, returns blog with most likes", () => {
...
describe("most likes", () => {
  test("when list has 5 blogs, returns author with most likes", () => {
